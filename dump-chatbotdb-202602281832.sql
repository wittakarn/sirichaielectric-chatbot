...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Users authorized to generate quotation PDFs';
...
INSERT INTO `authorized_users` VALUES (2,'Ucaba7f422b7205234c96c2e52531653e','X','2026-02-19 14:33:23'),(3,'Ufaebdbf00c01bdec6d760f49c4c42774','Pou','2026-02-19 14:33:23');
...
CREATE TABLE `messages` (
  ...
  `search_criteria` text COLLATE utf8mb4_unicode_ci COMMENT 'JSON array of search categories used by AI',
  PRIMARY KEY (`id`),
  KEY `idx_conversation_id` (`conversation_id`),
...
-- Dump completed on 2026-02-28 18:32:51
